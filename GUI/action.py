...
def submit_action(input_textbox, label_entry, output_textbox):
    ...
    # TODO Replace here the call to the model
    full_text = "{Marie} [organization] {Marie Dupont} [organization] {Dupont} [organization] is a data scientist at {OpenAI} [organization] and she specializes in {Python} [programming language] programming."
